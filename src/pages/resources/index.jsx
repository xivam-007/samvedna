...
const ResourcePage = () => {
  ...
  const mockThreads = [
    {
      id: 1,
      title: "Things to do when feeling anxious ",
      content: `Deep Breathing (Box Breathing) \n
...
This pulls your attention away from racing thoughts.\n
\n
Progressive Muscle Relaxation\n
Gently tense and release each muscle group (shoulders, fists, legs).\n
Anxiety often hides in the body.\n
\n
Splash Cold Water or hold an ice cube.\n
A sudden sensory shift can “reset” the brain.\n
\n
Write it Out\n
Journaling your thoughts quickly helps externalize worries so they don’t just circle in your mind.`,
      author: {
        name: 'Priya K.',
